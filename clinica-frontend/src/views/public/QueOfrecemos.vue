        ...
        <div class="max-w-5xl mx-auto">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-soft p-6 hover:shadow-teal-lg transition-all duration-300 transform hover:-translate-y-1">
              <div class="w-12 h-12 bg-teal-100 text-teal-600 rounded-full flex items-center justify-center mb-4">
                <i class="fas fa-hands-helping text-xl"></i>
              </div>
              <h3 class="text-xl font-semibold text-teal-700 mb-3">Acompañamiento terapéutico</h3>
            ...
            <div class="bg-white rounded-xl shadow-soft p-6 hover:shadow-teal-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 class="text-xl font-semibold text-teal-700 mb-3">Tratamiento psicofarmacológico</h3>
            ...
            <div class="bg-white rounded-xl shadow-soft p-6 hover:shadow-teal-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 class="text-xl font-semibold text-teal-700 mb-3">Evaluación y diagnóstico</h3>
            ...
            <div class="bg-white rounded-xl shadow-soft p-6 hover:shadow-teal-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 class="text-xl font-semibold text-teal-700 mb-3">Orientación familiar</h3>
            ...
            <div class="bg-white rounded-xl shadow-soft p-6 hover:shadow-teal-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 class="text-xl font-semibold text-teal-700 mb-3">Terapia grupal</h3>
            ...
            <!-- Enlace a actividades (sustituyendo la sección completa) -->
      ...
      <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="max-w-6xl mx-auto">
          <div class="flex flex-col md:flex-row gap-10">
            ...
            <!-- Columna 2: ÁREA DE INFANCIA Y ADOLESCENCIA -->
            <div class="md:w-1/3 bg-white p-6 rounded-xl shadow-soft transition-all duration-300 hover:shadow-teal-lg hover:-translate-y-1">
              <div class="bg-teal-600 text-white py-3 px-4 rounded-lg mb-6">
